...
namespace Lomtec.Proxy.Client
{
    ...
    public partial interface IUser
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<object>> CreateUserWithHttpMessagesAsync(UserCreateDto body = default(UserCreateDto), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update the user.
        /// </summary>
        /// <param name='body'>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<object>> UpdateUserWithHttpMessagesAsync(UserUpdateDto body = default(UserUpdateDto), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get the user.
        /// </summary>
        /// <param name='userId'>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<object>> GetUserWithHttpMessagesAsync(System.Guid userId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete the user.
        /// </summary>
        /// <param name='userId'>
